        ...
        child: Column(
          ...
          children: [
            ...
            DashCard(
              ...
              trailing: compliance != null
                  ? _ScoreBadge(score: compliance.complianceScore)
                  : null,
              children: compliance != null ? [
                  ...
                  children: compliance.advertisementRequirements.entries.map((e) {
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: e.value ? const Color(0xFF86EFAC) : const Color(0xFFE2E8F0),
                        ),
                      ),
                      child: Row(
                        ...
                        children: [
                          Icon(
                            e.value ? Icons.check_rounded : Icons.close_rounded,
                            size: 11,
                            color: e.value ? const Color(0xFF16A34A) : const Color(0xFF94A3B8),
                          ),
                          const SizedBox(width: 4),
                          Text(
                ...
                if (compliance.mandatoryClauses.isNotEmpty) ...[
                  const SizedBox(height: 14),
                  const Text('MANDATORY CLAUSES', style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: Color(0xFF94A3B8), letterSpacing: 0.8)),
                  const SizedBox(height: 6),
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  Expanded(
                                    child: Text(v.name, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: Color(0xFF0F172A))),
                                  ),
                                  const SizedBox(width: 6),
                                  const Icon(Icons.star_rounded, size: 12, color: Color(0xFFD97706)),
                                  const SizedBox(width: 2),
                                  Text(v.score.toStringAsFixed(1), style: const TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Color(0xFFD97706))),
                                ],
                              ),
                              const SizedBox(height: 3),
                              Text(
                                'Predicted: PKR ${_formatCurrency(v.predictedBidPkr)}',
            ...
            DashCard(
              ...
              children: [
                ...
                _ActionRow(
                  ...
                  title: portalPosting != null ? 'PPRA portal posted' : 'Portal posting pending',
                  subtitle: portalPosting?.referenceId ?? 'N/A',
                  isLast: true,
                  action: portalPosting != null ? 'Open' : null,
                  onAction: portalPosting != null
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, idx) {
        ...
        switch (agentName) {
          ...
          default:            dot = const Color(0xFF94A3B8); label = agentName;
        }
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            shape: BoxShape.circle,
            border: Border.all(
              color: done ? const Color(0xFF1E3A8A) : const Color(0xFFE2E8F0),
              width: 1.5,
            ),
          ),
          child: Center(
