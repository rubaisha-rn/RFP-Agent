...
class _SignupScreenState extends ConsumerState<SignupScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      setState(() {
        if (e.message.contains('exists') || e.message.contains('already registered')) {
  ...
  Widget build(BuildContext context) {
    ...
    final buttonColor = isVendor ? AppTheme.accentColor : AppTheme.primaryColor;
    String buttonLabel;
    if (isVendor) {
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: const TextStyle(fontSize: 26, fontWeight: FontWeight.bold, color: Colors.white, letterSpacing: -0.3, height: 1.1),
                ),
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: Container(
                          height: 2,
                          decoration: BoxDecoration(color: Colors.white.withOpacity(0.9), borderRadius: BorderRadius.circular(2)),
                        ),
                      ),
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (!isLogin) ...[
                        const _FieldLabel(text: 'Organisation name'),
                        const SizedBox(height: 6),
                        LabeledField(
                          label: '',
                          hintText: isVendor ? 'TechNova Solutions Pvt Ltd' : 'Punjab Procurement Authority',
                      ...
                      LabeledField(
                        label: '',
                        hintText: isVendor ? 'bids@yourcompany.pk' : 'you@organisation.gov.pk',
                      ...
                      if (isVendor && !isLogin) ...[
                        const SizedBox(height: 18),
                        const _FieldLabel(text: 'NTN Number'),
                        const SizedBox(height: 6),
                        LabeledField(
                          label: '',
                          hintText: '1234567',
                        ...
                        const SizedBox(height: 18),
                        const _FieldLabel(text: 'Categories (select at least 1)'),
...
class _FieldLabel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(
      text,
      style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: Color(0xFF374151), letterSpacing: 0.1),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        height: 52,
        decoration: BoxDecoration(
          color: _pressed ? widget.color.withOpacity(0.85) : widget.color,
